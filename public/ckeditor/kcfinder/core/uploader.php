...
//        }
    ...
    protected function normalizeFilename($filename) {
        if (isset($this->config['filenameChangeChars']) && is_array($this->config['filenameChangeChars'])){
        		$filename = $this->removeAccent($filename);
		  		...
		  		$filename = $this->removeExcessSpace($filename);
    ...
    protected function normalizeDirname($dirname) {
        if (isset($this->config['dirnameChangeChars']) && is_array($this->config['dirnameChangeChars'])){
				$dirname = $this->removeAccent($dirname);
				$dirname = strtolower($dirname);
				$dirname = $this->removeExcessSpace($dirname);
...
";
   ...
   protected function removeAccent($mystring){
		$marTViet = array(
					// Chữ thường
	...
	protected function removeExcessSpace($data){
