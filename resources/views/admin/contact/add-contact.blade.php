...
<div class="br-pagebody">
	<section class="listing-container">
	    <div class="br-section-wrapper container-fluid">
            {{-- @include("admin.error") --}}
            <form role="form" method="post" action="{{ route('admin.contact.add') }}" enctype="multipart/form-data">
            	@csrf
				<div id="myTabContent">
		            <div id="orther">
		                <div class="row">
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-sm-5 mg-b-10 mg-sm-b-10">
			                    <input type="text" name="title" value="" class="form-control" placeholder="Nhập địa tiêu đề">
			                </div>
		                </div>
		                <div class="row">
		                ...
		                <div class="row">
		                    <label class="col-sm-2 form-control-label">Trang thái</label>
		                	<div class="col-sm-5 mg-b-10 mg-sm-b-10">
                ...
                <div class="row mg-t-20">
                	...
                	<div class="col-sm-5 mg-b-10 mg-sm-b-10">
	                	...
	                	<a href="{{ route('admin.contact') }}"><button type="" class="btn btn-danger mg-r-20">Hủy</button></a>
	                </div>
                </div>
            </form>
        </div>
