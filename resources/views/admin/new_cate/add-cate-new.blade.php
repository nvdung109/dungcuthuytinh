...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      <a class="breadcrumb-item" href="{{route('admin.cate_news')}}">Danh mục</a>
...
<div class="br-pagebody">
	<section class="listing-container">
	    <div class="br-section-wrapper container-fluid">
            {{-- @include("admin.error") --}}
            <form role="form" method="post" action="{{ route('admin.cate_news.add') }}" enctype="multipart/form-data">
            	@csrf
				<div id="myTabContent">
		            <div id="orther">
		                <div class="row">
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-sm-5 mg-b-10 mg-sm-b-10">
			                    <input type="text" name="link" value="" class="form-control" placeholder="Nhập tên danh mục">
			                    {{old('link')}}
                ...
                <div class="row mg-t-20">
                	...
                	<div class="col-sm-5 mg-b-10 mg-sm-b-10">
	                	...
	                	<a href="{{ route('admin.cate_news') }}"><button type="reset" class="btn btn-danger mg-r-20">Hủy</button></a>
	                </div>
                </div>
            </form>
        </div>
