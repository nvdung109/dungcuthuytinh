    ...
    <div class="row">
      <div id="content" class="col-lg-12 col-sm-12">
        ...
        <div class="col-lg-6 col-sm-12">
          <p class="heading">Địa chỉ</p>
          <div class="panel panel-default">
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-12 google-map">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1862.3012759323249!2d105.86534925790322!3d21.008563200418376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abf84df4bf2f%3A0x64acf7f8f35b3459!2zMjE5IE5ndXnhu4VuIEtob8OhaSwgVGhhbmggTMawxqFuZywgSGFpIELDoCBUcsawbmcsIEjDoCBO4buZaSwgVmlldG5hbQ!5e0!3m2!1sen!2sus!4v1604549355751!5m2!1sen!2sus" width="100%" height="415" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-sm-12">
          <form action="{{ route('gopy.add')}}" method="post" enctype="multipart/form-data" class="form-horizontal lienhe">
            @csrf
            <fieldset>
              <p class="heading">Liên hệ với chúng tôi</p>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-email">Số điện thoại</label>
                <div class="col-sm-10">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-enquiry">Mô tả</label>
                <div class="col-sm-10">
              ...
              <button style="margin-left: 97px; width: 100px;" class="btn btn-primary btn-lienhe" type="submit">Gửi đi</button>
            </fieldset>
          </form>
        </div>
      </div>
