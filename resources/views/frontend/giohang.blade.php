...
<div id="checkout-cart" class="container">
  <div class="bg-color-b">
    <div class="row">
      <div id="content" class="col-sm-12">
        @if(session('flash_mes_del'))
              <div class="alert alert-success">
                {{ session('flash_mes_del') }}
              </div>
        @endif
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                <td style="font-weight: bold;" class="text-center">Tên</td>
                <td style="font-weight: bold;" class="text-center">Hình ảnh</td>
                <td style="font-weight: bold;" class="text-center">Giá</td>
                <td style="font-weight: bold;" class="text-center">Xóa</td>
              </tr>
            </thead>
              <tbody>
                @foreach($product_cart as $items)
                <tr>
                  <td style="width: 150px; text-align: center; text-decoration: none;">
                    <a href="san-pham/{{ $items['item']['url'] }}">
                      {{ $items['item']['name'] }}
                    </a>
                  </td>
                  <td class="text-center" style="width: 300px;">
                    <a href="chitietsp/{{ $items['item']['id'] }}">
                      <img src="/storage/products/{{$items['item']['image']}}" width="100" height="100" >
                    </a>
                  </td>
                  <td style="width: 150px; text-align: center;">{{ number_format($items['item']['price']) }} VNĐ</td>
                  <td style="width: 50px; text-align: center;">
                    <a style="" href="{{route('delcart', $items['item']['id'])}}">Xóa</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
  ...
  <div class="row">
    <div class="col-sm-4 col-sm-offset-8">
      <table class="table table-bordered">
        ...
        <tr>
          <td class="text-right"><strong>Tổng số tiền cần thanh toán:</strong></td>
          <td style="color: red" class="text-right">
            @if(Session::has('cart'))
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <a href="{{ route('sanpham')}}" class="btn btn-primary">Tiếp tục mua hàng &nbsp<i class="fa fa-arrow-right" aria-hidden="true"></i></a>
    </div>
  </div>
</div>
</div>
