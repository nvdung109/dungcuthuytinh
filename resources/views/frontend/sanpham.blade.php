...
<head>
  ...
  <meta property="og:title" content="Dụng cụ thủy tinh" />
    ...
    <div class="bg-color-b">
      <div class="row">
        ...
        <div id="content" class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
          <h1 style="margin: 0; margin-bottom: 25px;" class="heading">Dụng cụ thủy tinh</h1>
          <div class="row catebg">
            @foreach($pro as $item)
            <div class="product-layout product-grid col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <div class="product-thumb transition">
                <div class="image">
                  <a href="{{ url('san-pham', $item->url) }}"><img style="height: 260px; width: 100%" src="{{ asset('storage/products/' .$item->image)}}" alt="iMac" title="iMac" class="img-responsive center-block" /></a>
               </div>
               <div class="caption text-center">
                <h3 class="pro-name">
                  <a href="{{ url('san-pham', $item->url) }}">{{$item->name}}</a>
                </h3>
                <p class="list-des">Just when you thought iMac had everything, now there´s even more. More powerful Intel Core 2 Duo pro..</p>
                  <p class="price">
