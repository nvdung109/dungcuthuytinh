...
<div id="main">
  <div class="container">
    <p style="font-weight: 600; font-size: 25px; color: #0874d6; margin-top: 35px;">Tìm thấy ({{ count($product) }}) kết quả tìm kiếm</p><hr>
    <!-- sp bán chạy -->
    <div class="pro-bg">
           ...
           <div class="row">
              ...
              @foreach($product as $item)
                <div class="product-layout col-lg-3 col-sm-4 col-12">
                  <a href="{{ url('san-pham', $item->url) }}">
                    <div style="margin-bottom: 25px;" class="product-thumb transition">
                    <div class="image">
                      <a href="{{ url('san-pham', $item->url) }}"><img style="height: 260px; width: 100%" src="{{ asset('storage/products/' .$item->image)}}" alt="MacBook" title="MacBook" class="img-responsive center-block" /></a>
                    </div>
                   <div class="caption text-center">
                      <h3><a href="{{ url('san-pham', $item->url) }}">{{ $item->name }}</a></h3>
                      <p class="price">
