...
<head>
  ...
  <title>{{ $des_new->meta_title }}</title>
  <meta name="description" content="{{ $des_new->meta_description }}">
  <link rel="canonical" href="https://labvietchem.com.vn" />
  <meta name="robots" content="Index,Follow"/>
  <meta property="og:locale" content="vi_VN" />
  <meta property="og:site_name" content="LabVietChem" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="{{ $des_new->meta_title }}" />
  <meta property="og:description" content="{{ $des_new->meta_description }}" />
...
<div class="back">
  <ul class="breadcrumb">
    ...
    <li><a href="{{ route('danhmuctintuc', $des_new->id)}}">{{ $des_new->name }}</a></li>
  </ul>
</div>
<div class="container">
  <div class="bg-color-b">
    <div class="row">
      <div id="content" class="col-sm-9">
        <label class="heading">{{ $des_new->name }}</label>
        <div class="panel-default inspire_blog_page">
          @foreach($new as $item)
    ...
    <div class="sidebar-new">
      <div class="row">
        <div class="col-sm-3">
          <div style="margin-bottom: 30px" class="list-group cateleft">
