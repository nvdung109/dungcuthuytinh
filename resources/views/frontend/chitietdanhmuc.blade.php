...
<head>
  ...
  <title>{{ $des_cate->meta_title }}</title>
  <meta name="description" content="{{ $des_cate->meta_description }}">
  <link rel="canonical" href="https://labvietchem.com.vn" />
  <meta name="robots" content="Index,Follow"/>
  <meta property="og:locale" content="vi_VN" />
  <meta property="og:site_name" content="LabVietChem" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="{{ $des_cate->meta_title }}" />
  <meta property="og:description" content="{{ $des_cate->meta_description }}" />
...
<div id="product-category" class="common-shed">
    <div class="container">
    <div class="bg-color-b">
      <div class="row">
        <aside id="column-left" class="col-md-3 col-sm-4 col-xs-12">
          <div class="list-group cateleft">
            <label class="list-group-item">Danh mục sản phẩm</label>
            @foreach($cate as $item)
              <a href="{{ url('danh-muc', [$item->link, $item->id]) }}" class="list-group-item">{{ $item->name }}</a>
            @endforeach
          </div>
          ...
          <div class="pro-sale">
            ...
            <div class="product-thumb transition pro-view">
               <div class="image">
        ...
        <div id="content" class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
          ...
          @endif
          <div style="margin-bottom: 30px" class="inspdes"> 
            <h1>{{ $des_cate->name }}</h1>
            <p>{!! $des_cate->description !!}</p>
          </div>
          <div class="row catebg">
            ...
            <div class="product-layout product-grid col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <div class="product-thumb transition">
                <div class="image">
                  <a href="{{ url('san-pham', $item->url) }}"><img style="height: 250px; width: 100%" src="{{ asset('storage/products/' .$item->image)}}" alt="iMac" title="iMac" class="img-responsive center-block" /></a>
               </div>
               <div class="caption text-center">
                <h3 class="pro-name"><a href="{{ url('san-pham', $item->url) }}">{{$item->name}}</a></h3>
                  <p class="price">
                ...
                <div class="input-group col-xs-12 col-sm-12 qop">
                  <a href="{{ route('addcart', $item->id)}}">
                    <button type="button" class="acart" data-loading-text="Loading..." onclick="" class="btn btn-primary btn-lg btn-block">
